/**
 * Umberto Framework: Admin scripts
 *
 * @package	umberto
 * @since	umberto 1.0
 */
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		umberto_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.umberto_course_selector').on('click', function(e) {
		"use strict";
...
function umberto_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = umberto_get_listbox_selected_value(cat_fld.get(0));
